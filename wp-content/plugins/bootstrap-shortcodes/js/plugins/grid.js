tinymce.PluginManager.add('bs_grid', function(editor, url) {
    editor.addButton('bs_grid', {
        ...
        menu: [
            ...
            { text: '2 Columns',  onclick: function() { editor.insertContent('[bs_row class="row"]<br class="nc"/>[bs_col class="col-xs-6"]Text[/bs_col]<br class="nc"/>[bs_col class="col-xs-5"]Text[/bs_col]<br class="nc"/>[/bs_row]'); } },
